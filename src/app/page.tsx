...
const STATS = [
  ...
  { value: "в 5×", label: "дешевле профилактика", sub: "Чем лечение запущенных заболеваний" },
];
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="mt-5 text-lg text-black/50 max-w-2xl mx-auto">
            Каждый вопрос о здоровье заканчивается конкретным действием — записью, направлением, рекомендацией. Не советом в пустоту.
          </motion.p>
        </motion.div>
